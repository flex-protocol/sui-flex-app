...
export default function ChainResult({title, inputX, inputY, inputXToken, inputYToken, resultHash, currentChain, closeClick}) {
        ...
        <>
            ...
            <dialog id="my_modal_2" className="modal">
                ...
                <div className="modal-box ">
                    <Image alt='' onClick={closeClick} className="cursor-pointer" src="/close.svg" width={20} height={120}></Image>
